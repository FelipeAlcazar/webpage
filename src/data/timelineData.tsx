    ...
    content: (
      <>
        ...
        <div className="text-slate-500 italic sm:ml-24">
          Realizado en IES Berenguela de Castilla, Bolaños de Calatrava (Ciudad Real).
        </div>
        <div className="text-slate-500 italic sm:ml-24">
          1 de septiembre de 2017 - 1 de julio de 2019
        </div>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <div className="text-slate-500 italic sm:ml-24">
          Certificación oficial expedida por Trinity College London.
        </div>
        <div className="text-slate-500 italic sm:ml-24">
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <div className="text-slate-500 italic sm:ml-24">
          Realizado en IES Maestre de Calatrava, Ciudad Real. Modalidad bilingüe.
        </div>
        <div className="text-slate-500 italic sm:ml-24">
          1 de septiembre de 2019 - 1 de junio de 2021
        </div>
      </>
    ),
  },
  ...
  },
{
    ...
    content: (
      <>
        ...
        <div className="text-slate-500 italic sm:ml-24">
          Formación avanzada en gestión, liderazgo y tecnología para dirigir la transformación digital y proyectos innovadores en empresas. Modalidad online, impartido por la <a href="https://www.uclm.es/" className="text-blue-500 underline">Universidad de Castilla-La Mancha</a>.
        </div>
        <div className="text-slate-500 italic sm:ml-24">
          29 de septiembre de 2025 - 30 de junio de 2026 (fecha prevista)
        </div>
      </>
    ),
  },
